  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        <div className="w-12 h-12 rounded-full bg-foreground text-primary-foreground flex items-center justify-center text-lg font-semibold overflow-hidden">
          <img src="/logo.png" alt="RISE Scheduler" className="w-12 h-12 object-contain" />
        </div>
        <div>
          <p className="text-sm text-muted-foreground">RISE Scheduler</p>
        </div>
      </div>
