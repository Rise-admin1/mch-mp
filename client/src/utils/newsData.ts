export const newsItems = [
  ...
  },
  {
    ...
    content: ` 
      ...
      <p style=" font-size:1.25rem;">For Hon. Michael Mugenya, the meeting was a deliberate step in grounding his leadership journey in mentorship, strategic thinking, and community-centered collaboration. As he prepares to vie for the Funyula parliamentary seat, Mugenya emphasized the importance of learning from seasoned leaders and technocrats from the Samia community who have successfully navigated national responsibilities while remaining rooted in community values.</p>

      <p style=" font-size:1.25rem;">Discussions during the session reportedly focused on leadership ethics, inclusive development, youth empowerment, cultural identity, and how Funyula can better leverage its human capital for socio-economic transformation. Central to the dialogue was the need to “restore the fabric of the great Samia community” by reconnecting leadership with culture, shared values, and collective responsibility.</p>
  ...
  },
  {
    ...
    content: ` 
      ...
      <p style=" font-size:1.25rem;">Discussions between the two leaders centered on leveraging elective office to accelerate constituency-level development. Key among the strategies explored was the use of parliamentary influence to unlock funding for transformative projects through partnerships with established institutions such as Safaricom Foundation and the Center for Innovation and Development. Such collaborations, they noted, remain critical in bridging development gaps, particularly in underserved rural communities.</p>
      ...
      <p style=" font-size:1.25rem;">Beyond the election, the meeting explored avenues for future collaboration between the two leaders for the benefit of the wider Samia and Nambale regions. Proposed initiatives include solarized water projects, SME empowerment programs, and youth training and skills development, all aimed at fostering sustainable economic growth and resilience at the grassroots.</p>
