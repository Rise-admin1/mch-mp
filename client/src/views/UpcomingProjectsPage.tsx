  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      <div className="flex-1">
        <div className="relative h-screen flex items-center justify-center bg-[url('https://funyula.s3.ap-south-1.amazonaws.com/funyula-images/photo-convert/upcoming_project_header.avif')] bg-cover bg-center bg-no-repeat">
